...
El temario está alineado con los dominios oficiales de KCNA: Kubernetes Fundamentals, Container Orchestration, Cloud Native Application Delivery y Cloud Native Architecture, cubriendo los conocimientos necesarios para comprender escenarios de examen y aplicar conceptos básicos en entornos Kubernetes y cloud native.
...
- [11 Práctica 6. Exposición y validación de conectividad](Capitulo06/README.md#11-práctica-6-exposición-y-validación-de-conectividad)
  - Descripción: Actividad práctica orientada a exponer servicios y validar conectividad en Kubernetes, aplicando los conceptos de comunicación entre Pods y Services, DNS interno y tipos de Service.
  - Duración estimada: 60 min

### Capítulo 7

- [11 Práctica 7. RBAC y permisos básicos](Capitulo07/README.md#11-práctica-7-rbac-y-permisos-básicos)
  - Descripción: Actividad práctica orientada a aplicar RBAC y permisos básicos en Kubernetes mediante Roles, ClusterRoles, RoleBindings, ClusterRoleBindings y el principio de mínimo privilegio.
  - Duración estimada: 45 min
...
- [10 Práctica 9. Diagnóstico de fallas comunes](Capitulo09/README.md#10-práctica-9-diagnóstico-de-fallas-comunes)
